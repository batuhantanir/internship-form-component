    ...
    return (
        <div className=" bg-white  w-full max-w-2xl px-4 h-auto rounded-lg mx-4">
            <div className="flex justify-between border-b px-3 py-4">
                ...
                <IconBtn onClickEvent={()=>setPageOfOpen("")} icon={<RxCross2 />} />
            </div>
            <form onSubmit={handleSubmit}>
                ...
                <div className="border-t w-full p-5">
                    <button className="bg-primary text-white text-sm w-fit text-center gap-2 font-medium px-5 py-3 rounded-lg whitespace-nowrap "  type="submit">{btnName}</button>
                </div>
            </form>
        </div>
    )
